...
[_QWERTY] = LAYOUT(\
  ...
  MT(KC_LCTL, KC_TAB), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,         KC_H,    KC_J,    KC_K,        KC_L,    KC_SCLN, KC_QUOT, \
  KC_LALT,             KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,         KC_N,    KC_M,    KC_COMM,     KC_DOT,  KC_SLSH, KC_RBRC, \
                                         BSP_LWR, SPC_LSH, ENT_RSE,      ENT_RSE, SPC_RSH, DEL_LWR \
),
...
[_RAISE] = LAYOUT(\
           ...
           _______,  KC_PAST, KC_P4,   KC_P5,   KC_P6,   KC_PPLS,      KC_MUTE, KC_LEFT, KC_DOWN,   KC_RGHT, _______, KC_BSLS, \
           _______,  KC_P0,   KC_P1,   KC_P2,   KC_P3,   KC_PCMM,      KC_VOLD, KC_END,  KC_PSCR,   KC_PGDN, _______, KC_RCTL,  \
                                      _______, _______, _______,      _______, _______, _______\
),
