...
[_QWERTY] = LAYOUT(\
  KC_ESC,         KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,         KC_Y,    KC_U,    KC_I,        KC_O,    KC_P,    MT(MOD_LGUI, KC_LBRC), \
...
[_ADJUST] = LAYOUT(\
           RGB_MODE_PLAIN,  KC_ASUP, KC_ASTG, KC_ASDN, RESET,   EEP_RST,      EEP_RST, RESET,    KC_ASDN,  KC_ASTG, KC_ASUP, RGB_MODE_PLAIN, \
